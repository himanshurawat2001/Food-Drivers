...
export default function Navbar(props) {
    ...
    return (
        <div>
            <nav className="navbar navbar-expand-lg navbar-dark bg-transparent position-sticky"
                style={{ boxShadow: "0px 10px 20px black", filter: 'blur(20)', position: "fixed", zIndex: "10", width: "100%" }}>
                <div className="container-fluid">
                    <Link className="navbar-brand fs-1 fst-italic" to="/">FoodDrivers</Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        {(!localStorage.getItem("token")) ?
                            <form className="d-flex">
                                <Link className="btn bg-white text-black mx-1 btn-sm" to="/login">Login</Link>
                                <Link className="btn bg-white text-black mx-1 btn-sm" to="/signup">Signup</Link>
                            </form> :
                            <div>
